...
<div id="page" class="page">
    ...
    <div class="sidebar noselection" id="sidebar">
        <div class="sidebar-top">
            ...
            <svg id="sidebar-button" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-list" viewBox="0 0 16 16">
                ...
                <div class="formCard">
                    <div class="personalContainer">
                        ...
                        <div class="informationContainerPass">
                            ...
                            <a href="#" id="forgotPass" class="passChange">
